...
function createParticle(x, y) {
  ...
  document.getElementById(emojiId).appendChild(particle);
  ...
  TweenMax.to(particle, Math.random() * 2 + 1, {
    ...
    ease: Power2.easeOut,
    onComplete: function () {
      document.getElementById(emojiId).removeChild(particle);
    } });
...
var fourthpagescrolledboolean=document.getElementById(emojiId).getAttribute("bool-scrolled");
...
animateEmojiText("emoji-text","emojitext");
document.getElementById(emojiId).setAttribute("bool-scrolled","true");

}
else if(emoji_percent_scroll_animation>78.5){
animateEmojiText("emoji-text","emojitext");
document.getElementById(emojiId).setAttribute("bool-scrolled","true");
document.getElementById(emojiId).setAttribute("animation","true");
}
else{
...
var animBool=document.getElementById(emojiId).getAttribute("animation");
if(animBool=="true"){
...
animateEmoji("emoticons-img-Haha_face",1.6,"floating 3s ease-in-out infinite");
animateEmoji("emoticons-img-like",2.0,"floating 3s ease-in-out infinite");
document.getElementById(emojiId).setAttribute("animation","false");
